...
_dingtalkDocsCoolApp.fieldDecoratorKit.setDecorator({
  ...
  execute: function () {
    var _execute = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(context, formData) {
      var number, company, phone, res, trackDetails, trackDetailsText, _iterator, _step, item, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            number = formData.number, company = formData.company, phone = formData.phone;
            _context.p = 1;
            if (number) {
              _context.n = 2;
              break;
          ...
          case 2:
            _context.n = 3;
            return context.fetch("https://".concat(domain, "/kuaidi/logistics/track"), {
